...
import { BrandingDto, CreateApplicationDto, CreateWidgetDto, LayoutPresetDto, MetricsHistoryDto, ResetLayoutPresetDto, SaveLayoutDto, SelectLayoutPresetDto, SurfaceDto, UpdateApplicationDto, UpdateWidgetDto, WeatherQueryDto } from '../dto/dashboard.dto';
...
export class DashboardController {
  ...
  @UseGuards(JwtAuthGuard) @Get('metrics/history') metricsHistory(@Query() query: MetricsHistoryDto) {
