            ...
            <div className="docs-table">
              <table>
                ...
                <tbody>
                  ...
                  <tr><td><code>DASHLAB_AUTH_USER</code></td><td>dashlab</td><td>{text('Usuário da autenticação Basic.', 'Basic authentication user.')}</td></tr>
                  <tr><td><code>DASHLAB_AUTH_PASSWORD</code></td><td>gerado</td><td>{text('Senha Basic gerada pelo instalador.', 'Basic password generated by the installer.')}</td></tr>
                  <tr><td><code>OUTBOUND_ALLOWLIST</code></td><td>vazio</td><td>{text('Hosts privados autorizados para Prometheus e status.', 'Private hosts allowed for Prometheus and status checks.')}</td></tr>
                  <tr>
                    <td>
